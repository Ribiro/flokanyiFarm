	...
	<div class="page-top-info">
		<div class="container">
			<div class="site-pagination">
                <?php
                $catid = $_GET['id'];
                $que = mysqli_query($con, "SELECT * FROM category WHERE id = $catid  ");
                $result = mysqli_fetch_array($que);
                $catname = $result['name'];
                ?>
				<a href="index.php">Home</a> / <?php echo $catname ?> category
			</div>
		</div>
	</div>
	<!-- Page info end -->
    ...
    <section class="category-section spad">
        <div class="container">
            <div class="row">
                ...
                $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `products` WHERE category_id = $catid ");
                ...
                <div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
                    ...
                    <div class="row">
                        ...
                        $sql = mysqli_query($con, "SELECT * FROM products WHERE category_id = $catid LIMIT $offset, $total_records_per_page ");
